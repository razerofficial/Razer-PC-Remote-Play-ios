...
@property (nonatomic, assign) int videoRefreshRate;
@property (nonatomic, assign) int timeToTerminateApp;

@property (nonatomic, retain) NSNumber * hostFramerate;
@property (nonatomic, retain) NSNumber * hostHeight;
@property (nonatomic, retain) NSNumber * hostWidth;
